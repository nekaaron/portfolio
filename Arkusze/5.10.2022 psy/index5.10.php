...
<ol>
    <?php
        $wynik = mysqli_query($p , "select o.id , o.odpowiedz , k.nick from konta k , odpowiedzi o where o.pytania_id=1 and o.konta_id=k.id");

        while( ( $r=mysqli_fetch_array($wynik) ) != NULL ){
            echo "<li>".$r['odpowiedz']."<em>".$r['nick']."</em><hr/></li>";
        }
    ?>
</ol>
</div>
